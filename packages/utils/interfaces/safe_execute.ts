 ...
 */
    safeExecute<T, A extends unknown[]>(fn: (...args: A) => Promise<T>, ...args: A): Promise<[T | null, Error | null]>
    safeExecuteNoSync<T, A extends unknown[]>(fn: (...args: A) => T, ...args: A): [T | null, Error | null]
}
